...
import departmentController from "./src/entities/department/department.controller";
import shiftController from "./src/entities/shift/shift.controller";
